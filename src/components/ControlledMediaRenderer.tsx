...
const ControlledMediaRenderer: React.FC<ControlledMediaRendererProps> = ({ mediaArray, selectedMediaIndex }) => {
  ...
  const handleNextMedia = () => {
    setCurrentMediaIndex((prevIndex) => Math.min(prevIndex + 1, mediaArray.length - 1));
  };
